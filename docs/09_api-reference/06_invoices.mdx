...
| **customer** &nbsp &nbsp <Type>JSON</Type>&nbsp &nbsp <NotNullable>Not null</NotNullable> | [Customer object](/docs/api-reference/customers/customer-object). Billed customer |
| **subscription** &nbsp &nbsp <Type>JSON</Type>&nbsp &nbsp <NotNullable>Not null</NotNullable> | [Subscription object](/docs/api-reference/subscriptions/subscription-object). Billed subscription |
