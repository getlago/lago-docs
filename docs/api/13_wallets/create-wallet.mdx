...
<Tabs groupId="prog-language">
  ...
  let wallet = new Wallet({name: 'wallet_name', rate_amount: '1.5', paid_credits: '20.0',
    granted_credits: '10.0', expiration_at: '2022-07-07T23:59:59Z', external_customer_id: '12345'
  })
...
<Tabs>
  ...
  **Possible errors:**
  ...
  | `customer` | `no_active_subscription` | Customer does not have an active subscription |
