...
| aggregation_type | String &nbsp &nbsp &nbsp<Required>**Required**</Required> | Aggregation type that is used in event calulations.<br></br>It can be `count_agg`, `sum_agg`, `max_agg` or `unique_count_agg` |
