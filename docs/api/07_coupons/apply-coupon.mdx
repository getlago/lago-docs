...
| frequency_duration | Integer &nbsp &nbsp &nbsp<Optional>**Optional**</Optional> | This field determines number of billing periods to which the coupon is applied.<br></br>If defined, it overrides the frequency_duration property of the coupon |
