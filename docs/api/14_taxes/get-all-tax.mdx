...
```curl title="GET"
/api/v1/taxes?per_page=2&page=1
```
...
namespace Example
{
  public class FindAllTaxesExample
  {
      public static void Main()
      {
          ...
          {
              Debug.Print("Exception when calling TaxesApi.FindAllTaxes: " + e.Message );
...
<Tabs>
  ...
  Taxes were successfully found

  Returns a list of [tax](./tax-object) objects.
