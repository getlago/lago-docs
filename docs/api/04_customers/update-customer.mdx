...
| id | String &nbsp &nbsp &nbspRequiredUnderCondition>**Required conditionally**</RequiredUnderCondition> | Metadata object identifier - only required when updating metadata |
