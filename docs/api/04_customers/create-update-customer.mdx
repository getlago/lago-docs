...
| timezone | String &nbsp &nbsp &nbsp<Optional>**Optional**</Optional> | [Timezone](../resources/timezones) of the customer.<br></br>It will override the one defined at organization level |
