...
<Tabs groupId="prog-language">
  ...
  client.groups().find_all({'code': 'billable_metric_code', 'per_page': 2, 'page': 1})
  ```
  </TabItem>
  ...
  client.groups.get_all({ code: 'billable_metric_code', per_page: 2, page: 3 })
  ```
  </TabItem>
  ...
  await client.findAllGroups({code: 'billable_metric_code', per_page: 2, page: 3});
  ```
  </TabItem>
...
| **key** &nbsp &nbsp <Type>String</Type> &nbsp &nbsp <NotNullable>Not null</NotNullable> | Group key |
