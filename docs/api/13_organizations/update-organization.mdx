...
| Attributes | Type | Description |
| -----------| -----| ----------- |
| vat_rate | Float &nbsp &nbsp &nbsp<Optional>**Optional**</Optional> | Custom VAT rate.<br/>Will be converted into an applied by default [tax rate](../tax_rates/tax-rate-object) object. |
