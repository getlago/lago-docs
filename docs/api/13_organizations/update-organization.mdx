...
| email_settings | Array &nbsp &nbsp &nbsp<Optional>**Optional**</Optional><br></br><Comment></Comment> | |
| billing_configuration | Object &nbsp &nbsp &nbsp<Optional>**Optional**</Optional> Possible Values are `invoice.finalized` and `credit_note.created`</Comment> | Email settings of the organization |
