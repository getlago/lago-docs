...
| expiration_duration | String &nbsp &nbsp &nbsp<Optional>**Optional**</Optional> | Coupon duration<br></br>It won't be updated if coupon is attached to any subscriptions |
## Responses
