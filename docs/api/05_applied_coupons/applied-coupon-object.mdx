...
It lets you assign recuring coupons to customers.
...
| **coupon_code** &nbsp &nbsp <Type>String</Type> | Code identifying the coupon. |
...
| **terminated_at** &nbsp &nbsp <Type>String</Type> | Date of manual deletion of the coupon from customer's coupons. |
