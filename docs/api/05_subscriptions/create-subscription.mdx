...
| subscription_date | String &nbsp &nbsp &nbsp<Optional>**Optional**</Optional> | Used for creating subscription that started in the past or will start in the future. |
