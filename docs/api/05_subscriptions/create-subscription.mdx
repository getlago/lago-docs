...
| unique_id | String &nbsp &nbsp &nbsp<Required>**Required**</Required> | External identifier for subscription.<br></br>It has to be unique per customer's active subscription scope. |
