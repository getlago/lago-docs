...
| **unique_id** &nbsp &nbsp <Type>String</Type> &nbsp &nbsp <NotNullable>Not null</NotNullable> | Unique external identifier of the subscription. Used as an idempotency key. Corresponds to the `external_customer_id` for subscriptions created before August 8th, 2022. |
