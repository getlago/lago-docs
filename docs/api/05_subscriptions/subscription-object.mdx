...
| **unique_id** &nbsp &nbsp <Type>String</Type> &nbsp &nbsp <NotNullable>Not null</NotNullable> | External unique identifer of the subscription. It should be unique in customer's active subscription scope |
