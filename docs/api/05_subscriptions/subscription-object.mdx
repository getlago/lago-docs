...
| **subscription_at** &nbsp &nbsp <Type>String</Type> &nbsp &nbsp <NotNullable>Not null</NotNullable><br></br><Comment>*ISO 8601 datetime in UTC*</Comment> | Anniversary date and time of the initial subscription. It is used a the based date to bill subscription with anniversary billing time. |
