...
| **billing_time** &nbsp &nbsp <Type>String</Type> &nbsp &nbsp <NotNullable>Not null</NotNullable> | Billing time of the subscription. <br></br> <details><summary>**Possible values**</summary><div>- `anniversary`: Subscription will be billed on each week/month/year anniversray, depending on the plan reccurence<br></br>- `calendar`: Subscription at the end of week/month/year. The first subscription billing will be at pro-rata if it is not created at the beginning of the week/month/year</div></details> |
