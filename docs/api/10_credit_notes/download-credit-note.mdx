...
```curl title="POST"
/api/v1/credit_notes/:id/download
```
...
<Tabs groupId="prog-language">
  ...
  invoice = client.credit_notes().download('5eb02857-a71e-4ea2-bcf9-57d8885990ba') # Credit Note ID
  ```
  </TabItem>
  ...
  client.credit_notes.download('5eb02857-a71e-4ea2-bcf9-57d8885990ba') // Credit Note ID
  ```
  </TabItem>
  ...
  await client.downloadCreditNote('id');
  ```
  </TabItem>
