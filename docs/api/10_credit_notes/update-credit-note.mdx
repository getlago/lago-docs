...
--header 'Content-Type: application/json' \
  ...
  ```javascript
  import CreditNote from 'lago-node-js-client/credit_note'

  let client = new Client('__API_KEY__')

  let creditNoteUpdate = new CreditNote({
    refundStatus: "refunded",
  })

  await client.updateCreditNote(creditNoteUpdate, 'credit-note-id')
  ```
...
|--|--|--|
| refund_status | String &nbsp &nbsp &nbsp<Required>**Required**</Required> | Credit Note refund status <br></br> It can be `pending` or `refunded` |
