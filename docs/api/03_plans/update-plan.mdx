...
<Tabs>
  ...
  **Possible errors:**
  ...
  | `code` | `value_already_exist` | `code` value is already used on an other plan |
  ...
  | `properties` | `invalid_graduated_ranges` | One of the range attributes are invalid |
  | `properties` | `invalid_amount` | One of the `per_unit_amount` or `flat_amount` values are invalid |
  ...
  | `properties` | `invalid_ranges` | One of the range attributes are invalid |
  | `properties` | `invalid_amount` | One of the `per_unit_amount` or `flat_amount` values are invalid |
