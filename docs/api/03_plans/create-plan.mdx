...
curl --location --request POST "$LAGO_URL/api/v1/plans" \
  ...
  const standardChargeObject = {
    ...
    charge_model: "standard" as ChargeObject["charge_model"],
    instant: false,
    groupProperties: [
      {
        groupId: "group_id",
  ...
  const graduatedChargeObject = {
    ...
    created_at: null,
    lago_billable_metric_id: "id",
    charge_model: "graduated" as ChargeObject["charge_model"],
    instant: false,
    properties: [
      {
        to_value: 10,
  ...
  const packageChargeObject = {
    ...
    created_at: null,
    lago_billable_metric_id: "id",
    charge_model: "package" as ChargeObject["charge_model"],
    instant: false,
    properties: {
      amount: "100",
      free_units: 10000,
  ...
  const percentageChargeObject = {
    ...
    created_at: null,
    lago_billable_metric_id: "id",
    charge_model: "percentage" as ChargeObject["charge_model"],
    instant: false,
    properties: {
      rate: "0.5",
      fixed_amount: "1",
  ...
  const volumeChargeObject = {
    ...
    created_at: null,
    lago_billable_metric_id: "id",
    charge_model: "volume" as ChargeObject["charge_model"],
    instant: false,
    properties: {
      volume_ranges: [
        {
