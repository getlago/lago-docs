...
| **external_subscription_id** <Type>String</Type> | Unique identifer of the subscription in your application.<br/>Present only if fee has `instant_charge` fee_type. |
| **lago_subscription_id** <Type>String</Type> | Unique identifer of the subscription in Lago application.<br/>Present only if fee has `instant_charge` fee_type. |
| **external_customer_id** <Type>String</Type> | Unique identifer of the customer in your application.<br/>Present only if fee has `instant_charge` fee_type. |
| **lago_customer_id** <Type>String</Type> | Unique identifer of the customer in Lago application.<br/>Present only if fee has `instant_charge` fee_type. |
| **event_transaction_id** <Type>String</Type> | Event's transaction_id that triggered the fee.<br/>Present only if fee has `instant_charge` fee_type. |
