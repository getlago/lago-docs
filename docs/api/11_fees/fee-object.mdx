...
| **from_date** &nbsp &nbsp <Type>String</Type><br>/<br/><Comment>*ISO 8601 date*</Comment> | Beginning date of the period that the fee covers. <br></br> <details>Only applies to `subscription` and `charge` fees</details> |
| **to_date** &nbsp &nbsp <Type>String</Type><br></br/><Comment>*ISO 8601 date*</Comment> | Ending date of the period that the fee covers. <br></br> <details>Only applies to `subscription` and `charge` fees</details> |
