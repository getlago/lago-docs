...
This object represents the charge usage of a customer of your business on the current billing period.<br/>
It lets you monitor the customer usage
...
| Attributes | Description |
| -----------| ----------- |
| **lago_id** &nbsp &nbsp <Type>String</Type> &nbsp &nbsp <NotNullable>Not null</NotNullable> | ID of the charge in lago application |
...
| Attributes | Description |
| -----------| ----------- |
| **lago_id** &nbsp &nbsp <Type>String</Type> &nbsp &nbsp <NotNullable>Not null</NotNullable> | ID of the billable metric in lago application |
